...
export const drawAssayTimepointViewer = (props: AssayTimepointViewerProps) => {
    ...
    yaxispolygons
        ...
        .on("mouseover", function (d) {
            ...
            arrow
                ...
                .style("opacity", 0.9);
            arrow
                .style("left", r - (margin.left / 2 - 5) + "px")
                .style("top", t - 12 + "px");
            tooltip
                .html(
                    d.label + "<br>" +
        ...
        xaxis
            ...
            .on("mouseover", function (d) {
                ...
                arrow
                    ...
                    .style("opacity", 0.9);
                arrow
                    .style("left", r - (xaxisScale.bandwidth() - 5) + "px")
                    .style("top", t - 12 + "px");
                tooltip
                    .html(
                        "Day " + d.label + "<br>" +
                    ...
                    .style("left", r - xaxisScale.bandwidth() + "px")
                    .style("top", t - 50 - 12 + "px");
            })
            .on("mouseout", function (d) {
                // Reset to original
